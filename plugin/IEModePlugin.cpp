// IEModePlugin.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CIEModePluginApp, CWinApp)
END_MESSAGE_MAP()


// CIEModePluginApp construction

CIEModePluginApp::CIEModePluginApp()
{
...
// The one and only CIEModePluginApp object

CIEModePluginApp theApp;
...
// CIEModePluginApp initialization

BOOL CIEModePluginApp::InitInstance()
{
	AfxOleInit();
...
int CIEModePluginApp::ExitInstance()
{
